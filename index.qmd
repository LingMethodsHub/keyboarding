...
While we're on the subject, here's forward slash, used to separate directories on Unix-like systems (including Mac).
...
## Mac
```{r}
#| fig.cap: "square brackets on the mac keyboard"
#| cap-location: margin
#| out-width: 100%
#| fig-width: 10
#| fig-height: 4
...
## Mac
```{r}
#| fig.cap: "bar location on the mac keyboard"
#| cap-location: margin
#| out-width: 100%
#| fig-width: 10
#| fig-height: 4
